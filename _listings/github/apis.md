...
- name: Github
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/deployments/master/_listings/github/repos-owner-repo-deployments-id-statuses-post.md
- name: Github Get Repos Owner Repo Deployments  Statuses
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/deployments/master/_listings/github/repos-owner-repo-deployments-id-statuses-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/deployments/master/_listings/github/repos-owner-repo-deployments-id-statuses-get-postman.md
x-common:
- type: x-net-library
