...
- name: AWS API Gateway API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/deployments/master/_listings/aws-api-gateway/restapis-fugvjdxtri-deployments-limit-2-get.md
x-common:
